...
function ShortTerm_2024() {
    ...
    useEffect(() => {
      ...
      const fetchData = async () => {
        try {
          const response = await fetch('http://localhost:3040/api/getShortTerm2024');
    ...
    const options = {
        ...
        title: {
          text: "Short Term Data of Goal Type in 2024"
        },
        data: [
          {
            type: "pie",
